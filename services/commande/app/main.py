...
séquence les étapes synchrones (Restaurant, Paiement) puis asynchrone (Livraison
via RabbitMQ), et pilote les compensations. Au démarrage il crée ses tables (`orders`, `order_items`, `saga_log`)
